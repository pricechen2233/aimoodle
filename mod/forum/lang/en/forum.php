...
$string['eventrobotreplyed'] = 'Robot replyed'; //--------------------------!
...
$string['slicepostsfail'] = 'slice posts fail, ask admin now!'; //----------------!
$string['failtopostapi'] = 'Fail to tell with robot, please try a later or ask the admin!'; //---------------------!
$string['rejectreply'] = 'This post is robot reply, you can let the robot reply itself. You must think and ask more question.'; //---------------------!
$string['emptymergedposts'] = 'Empty merged posts!';//-------------------------!
$string['apiunkownerror'] = 'Api request failed, and error is unkown!';//-----------------------!
$string['ragerror'] = 'rag agent has bad request, please ask the admin immediately!';//-------------------------------!
$string['userobotreply'] = 'Use robot to reply'; //-----------------------------!
$string['configuserobotreply'] = 'If you want to use the robot to reply the posts, select Yes'; //-------------------------!
$string['gpt3model'] = 'gpt-3.5-turbo'; //-----------------!
$string['gpt4ominimodel'] = 'gpt-4o-mini'; //-------------------!
$string['ragmodel'] = 'model with rag tech'; //----------------!
$string['setmodel'] = 'Set model'; //-----------------!
$string['configsetmodel'] = 'Please select the robot'; //--------------------!
$string['connecturl'] = 'url of api'; //-------------------------!
$string['configconnecturl'] = 'input the api url of model or rag'; //--------------------!
$string['chatid'] = 'the chat assailant id'; //---------------------!
